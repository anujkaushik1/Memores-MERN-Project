    ...
    <div className='carditems-main'>
      ...
      <div className='cards'>
        ...
        <Grid sm={12} lg={10} xs={12} md={10} container position={'relative'} left={'15.5rem'} top={'10px'} >
          ...
          <Grid item bottom={8} marginTop = {2} paddingLeft={2} paddingRight={2} position={'relative'}>
            <Box>
              <Card variant='elevation' sx={{ width: 270, borderRadius: 3 }}>
                <Typography component='span' variant='body2' sx={{margin : 0, padding : 0, position : 'absolute', top : '1rem', left : '1.5rem', fontSize : '18px' ,fontWeight : '540', color : 'white'}}>
                    Hello worldddd
                </Typography>

                <Typography component='span' variant='body2' sx={{margin : 0, padding : 0, position : 'absolute', top : '2.6rem', left : '1.5rem', fontSize : '12px', fontWeight : '540', color : 'white'}}>
                   2 months ago
                </Typography>
                <CardMedia
                  component="img"
